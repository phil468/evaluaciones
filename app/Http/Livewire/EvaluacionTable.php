...
class EvaluacionTable extends LivewireDatatable
{
    ...
    public function columns()
    {
        return [
            ...
            DateColumn::name('evaluaciones.fecha_inicio_primera_fase_matricula')->label('Fecha de inicio de la primera fase de matrícula')->searchable(),
            ...
            DateColumn::name('evaluaciones.fecha_inicio_segunda_fase')->label('Fecha de inicio de la segunda fase')->searchable(),
            DateColumn::name('evaluaciones.fecha_fin_segunda_fase')->label('Fecha de fin de la segunda fase')->searchable(),
