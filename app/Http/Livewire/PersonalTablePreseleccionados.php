...
class PersonalTablePreseleccionados extends LivewireDatatable
{
    ...
    protected $listeners = [
        'closeModal' => '$refresh',
        'limpiarSeleccionPersonalTable'=>'limpiarSeleccionPersonalTable',
        'emitSelectedUpdated' => 'reciveSelectedUpdated'
    ];
    ...
    public function reciveSelectedUpdated($value)
    {
        // dd($value);
        $this->selected = $value;
        // $this->emitUp('selectedUpdated', $value);
    ...
    public function builder()
    {
            ...
            ->whereIn('personal.id', $this->selected) // <-- Filtrar por los IDs seleccionados
            ;
        // }
    }
