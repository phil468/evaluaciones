        ...
        <div class="col-md-12">
            <div class="card rounded-xl">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="float-right">
                            <a type="button" class="btn btn-default rounded-xl"
                                href="{{ url('/evaluaciones-de-desempeno/2') }}">Volver</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tipo_objetivo_id1" wire:model="tipo_objetivo_id1">
                                    @foreach ($tipos_objetivo as $tipo)
                                        <option value="{{ $tipo->id }}">{{ $tipo->unidad . '(' . $tipo->simbolo . ')' }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="resultado1" wire:model="resultado1"
                                    disabled>
                                @error('cantidad2')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="evidencia1" wire:model="evidencia1"
                                    disabled>
                                @error('evidencia1')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="cantidad2">Resultado:</label>
                                <input type="number" class="form-control" id="resultado2" wire:model="resultado2"
                                    disabled>
                                @error('cantidad2')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                    ...
                    <div>
                        <a type="button" href="{{ url('/evaluaciones-de-desempeno/2') }}"
                            class="rounded-full btn btn-outline-vanguard">Volver</a>
                        <button type="button" wire:click.prevent="guardar_objetivos()"
                            class="mx-1 rounded-full btn btn-vanguard">Guardar</button>
                    </div>
                    <br>
                    <div>
                        <h1 class="h5">
                        ...
                        <ol>
                            <li>
                                Reducir en un 10% las incidencias, por intrusión de personal no identificado, al
                                establecimiento durante todo el periodo 24/25 vs 23/24.
                            </li>
                            <li>
                                Cumplir con 145 inspecciones de actos y condiciones de seguridad durante todo el periodo
                                24/25
                            </li>
                        </ol>
                        {{-- <div>
