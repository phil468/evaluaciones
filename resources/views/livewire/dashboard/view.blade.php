    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card rounded-xl">
                <div class="text-white card-header bg-vanguard rounded-t-xl" {{-- style="background-image: linear-gradient(90deg, #568ba5 0%, #500aa0 100%);" --}}
                    @if (!$showHeader) hidden @endif>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="bottom-0 right-0 p-3 position-fixed z-index-3"
                            style="z-index: 0; right: 0; bottom: 6em; opacity: 0.90;">
                    ...
                    @if (!$vista_personal)
                        <div class="row">
                            <div class="form-group col-md-4 col-sm-4" wire:ignore>
                                ...
                                <select name="gerencia_sub_gerencia_de_evaluado" class="form-control"
                                    id="gerencia_sub_gerencia_de_evaluado" placeholder="Gerencias/Sugerencias">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div style="width: 100%; height: 600px;"> <!-- Ajusta la altura según necesites -->
                                <canvas wire.ignore id="chart"
                                    @if (!$mostrar_grafica) style="display:none;" @endif>
                                </canvas>
                            </div>
                            ...
                            @if ($mostrar_grafica === false)
                                ...
                                @if (!$this->evaluacionPorCompetenciasFinalizada)
                                    <div class="alert alert-default rounded-2xl" role="alert">
                                        Una vez finalizada la evaluación de desempeño por competencias, se mostrarán los
