    ...
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <tbody>
            ...
            <tr class="row10">
                ...
                <td class="column1 style19 s style19" colspan="6">{{ $devolucion_guardada['personal']['name'] }}
                </td>
            </tr>
            <tr class="row11">
            ...
            <tr class="row14">
                ...
                <td class="column1 style19 s style19" colspan="6">{{ $devolucion_guardada['responsable']['name'] }}
                </td>
            </tr>
            <tr class="row15">
                <td class="column0 style18 s">AREA</td>
                <td class="column1 style19 s style19" colspan="6">
                    {{ $devolucion_guardada['responsable_area']['name'] }}</td>
            </tr>
            <tr class="row16">
            ...
            <tr class="row33">
                <td class="column0 style40 s style40" colspan="3">
                    {{ $devolucion_guardada['responsable']['name'] }}</td>
                <td class="column3 style41 null"></td>
                <td class="column4 style42 f style42" colspan="3">{{ $devolucion_guardada['personal']['name'] }}
                </td>
            </tr>
            <tr class="row34">
                <td class="column0 style43 s style43" colspan="3">
                    {{ $devolucion_guardada['responsable_cargo']['name'] }}</td>
                <td class="column3 style16 null"></td>
                <td class="column4 style18 s">DNI:</td>
                <td class="column5 style44 n style45" colspan="2">{{ $devolucion_guardada['personal']['dni'] }}
                </td>
            </tr>
            <tr class="row35">
                <td class="column0 style16 null"></td>
