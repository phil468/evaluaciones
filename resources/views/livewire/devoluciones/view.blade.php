    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card rounded-xl">
                        ...
                        @if ($createMode)
                            @can('crear-devolucion')
                                ...
                                @else
                                    ...
                                    <a class="btn btn-lg btn-default" wire:click="store()">
                            ...
                            @if ($createMode)
                                @can('crear-devolucion')
                                    ...
                                    @else
                                        ...
                                        <a class="btn btn-lg btn-primary" wire:click="store()">
                ...
                <div wire:loading
                    wire:target="importar,exportar,create,edit,destroy,agregar,store,update,quitar_activo,edit_activo,update_activo,guardarFirma,generarPdf,descargarPDF,pdfMode,notPdfMode, personal_id, responsable_id, buscar_dni, seleccionar_activo, deseleccionar_activo, seleccionar_activo_asignado, agregar_asignados">
                    <x-loading-indicator />
                </div>
