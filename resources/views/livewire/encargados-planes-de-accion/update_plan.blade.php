    ...
    <div class="modal-dialog" role="document">
        <div class="rounded-2xl modal-content">
            ...
            <div class="modal-footer">
                <button type="button" wire:click.prevent="cancel_plan()" class="btn btn-secondary rounded-xl" data-dismiss="modal">Cerrar</button>
                <button type="button" wire:click.prevent="update_plan()" class="btn btn-vanguard rounded-xl">Guardar</button>
            </div>
       </div>
    </div>
</div>
