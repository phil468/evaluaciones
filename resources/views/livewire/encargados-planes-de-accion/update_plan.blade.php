                ...
                <form>
                    <fieldset class="row" wire:target="edit,store,update" wire:loading.attr="disabled">
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            ...
                            <input wire:model="fecha_de_revision" type="date" class="form-control" id="fecha_de_revision" placeholder="Fecha De Revision" min="{{ now()->addMonths(6)->format('Y-m-d') }}" max="2025-03-15">
