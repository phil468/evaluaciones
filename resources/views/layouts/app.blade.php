...
<head>
    ...
    <link nonce="{{ $nonce }}" href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">

    <!-- SweetAlert -->
    {{-- <script nonce="{{ $nonce }}" src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script> --}}
