                    ...
                    <div class="text-white card-header bg-vanguard rounded-t-xl">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div class="float-left">
                                <h5 class="h5">Niveles Jerárquicos</h5>
                            </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-vanguard">
                    <h5 class="text-white modal-title h5" id="editModalLabel">Editar Nivel Jerárquico</h5>
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function() {
            var table = new Tabulator("#example-table", {
                ajaxURL: "{{ route('nivel_jerarquicos.data') }}",
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        formatter: function(cell, formatterParams) {
                            return "@can('editar-nivel-jerarquico')<button class='text-white btn btn-sm btn-warning edit-button' data-id='" +
                                cell.getRow().getData().id +
                                "'><i class='fas fa-edit'></i></button>@endcan" +
                                "@can('borrar-nivel-jerarquico')<button class='btn btn-sm btn-danger delete-button' data-id='" +
                                cell.getRow().getData().id +
            ...
            $('#saveChanges').on('click', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        var url = (id == '') ? "{{ route('nivel_jerarquicos.store') }}" :
                            "{{ route('nivel_jerarquicos.update', '') }}/" + id;
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: '¡Éxito!',
                                    text: 'Nivel Jerárquico actualizado correctamente.',
                                });
                                table.replaceData();
                            },
                            error: function(xhr, status, error) {
                                Swal.fire({
                                    icon: 'error',
                                    title: '¡Error!',
                                    text: 'No se pudo actualizar el Nivel Jerárquico.',
                                });
                            }
                        });
                    }
            ...
            $("#example-table").on("click", ".delete-button", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('nivel_jerarquicos.destroy', '') }}/" + id,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            },
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
                                    title: '¡Éxito!',
                                    text: 'Nivel Jerárquico eliminado correctamente.',
                                });
                                table.replaceData();
                            },
                            error: function(xhr, status, error) {
                                Swal.fire({
                                    icon: 'error',
                                    title: '¡Error!',
                                    text: 'No se pudo eliminar el Nivel Jerárquico.',
                                });
                            }
                        });
                    }
