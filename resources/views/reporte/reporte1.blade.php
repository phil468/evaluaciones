...
<body>
            ...
            <div class="col-md-12">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center text-size2 sinborde_bottom" colspan="2">
                                {{ $datar['fruto_color'] }}</td>
                            <td class="text-right">TARA PARIHUELA : </td>
                            <td class="text-center sinborde_left">{{ $datar['tara_parihuela'] }}</td>
                        </tr>
                        <tr>
                            <td class="text-center text-size2" colspan="2">{{ $datar['fruto_color_traduccion'] }}
                            </td>
    ...
    <script nonce="{{ $nonce }}" src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"
