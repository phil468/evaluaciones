                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-2 progress" style="height: 25px;">
                                                <div id="barra-competencias" class="progress-bar bg-primary"
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h6>Primera Fase</h6>
                                            <div class="mb-2 progress" style="height: 25px;">
                                                <div id="barra-objetivos-1" class="progress-bar bg-primary"
                                                    role="progressbar" style="width: 0%">
                                                    0%
                                                </div>
                                            </div>
                                            ...
                                            <h6>Segunda Fase</h6>
                                            <div class="mb-2 progress" style="height: 25px;">
                                                <div id="barra-objetivos-2" class="progress-bar bg-secondary"
                                                    role="progressbar" style="width: 0%">
                                                    0%
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h6>Primera Fase</h6>
                                            <div class="mb-2 progress" style="height: 25px;">
                                                <div id="barra-planes-1" class="progress-bar bg-primary" role="progressbar"
                                                    style="width: 0%">
                                                    0%
                                                </div>
                                            </div>
                                            ...
                                            <h6>Segunda Fase</h6>
                                            <div class="mb-2 progress" style="height: 25px;">
                                                <div id="barra-planes-2" class="progress-bar bg-secondary"
                                                    role="progressbar" style="width: 0%">
                                                    0%
                                                </div>
                                            </div>
    ...
    <script nonce="{{ $nonce }}" type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
                    ...
                    },
                    {
                        ...
                        columns: [{
                                ...
                                formatter: function(cell) {
                                    ...
                                    return generarBarraProgresoCompacta(data[0], data[1],
                                        porcentaje);
                                },
                                headerSort: false,
                                minWidth: 120,
                            ...
                            },
                            {
                                ...
                                accessorDownload: function(value, data) {
                                    return data.competencias[0] >= data.competencias[1] ?
                                        'Completo' : 'Incompleto';
                                },
                                minWidth: 50
                            }
                    ...
                    },
                    {
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                accessorDownload: function(value, data) {
                                    return data.objetivos_fase1.completo ? 'Completo' :
                                        'Incompleto';
                                },
                                sorter: function(a, b, aRow, bRow) {
                                    let aData = aRow.getData().objetivos_fase1;
                                    let bData = bRow.getData().objetivos_fase1;
                                    return (aData.completo === bData.completo) ? 0 : (aData
                                        .completo ? -1 : 1);
                                },
                                ...
                                headerFilterFunc: function(headerValue, rowValue, rowData) {
                                    return headerValue === rowData.objetivos_fase1.completo
                                        .toString();
                                },
                                headerSortTristate: true,
                                minWidth: 20
                            ...
                            },
                            {
                                ...
                                accessorDownload: function(value, data) {
                                    return data.objetivos_fase2.completo ? 'Completo' :
                                        'Incompleto';
                                },
                                sorter: function(a, b) {
                                    return (a.completo === b.completo) ? 0 : (a.completo ? -1 :
                                        1);
                                },
                                headerFilter: "dropdown",
                                headerFilterParams: {
                    ...
                    },
                    {
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                accessorDownload: function(value, data) {
                                    return data.planes_fase1.completo ? 'Completo' :
                                        'Incompleto';
                            ...
                            },
                            {
                                ...
                                accessorDownload: function(value, data) {
                                    ...
                                    return data.planes_fase2.completo ? 'Completo' :
                                        'Incompleto';
                                },
                                sorter: function(a, b) {
                                    return (a.completo === b.completo) ? 0 : (a.completo ? -1 :
                ...
                downloadConfig: {
                    ...
                    formatData: function(data) {
                        return data.map(row => ({
                            ...
                            "ESTADO COMPETENCIAS": row.competencias[0] === row.competencias[
                                1] ? "COMPLETO" : "PENDIENTE",
                            "ESTADO OBJETIVOS F1": row.objetivos_fase1.completo ?
                                "COMPLETO" : "PENDIENTE",
                            "ESTADO OBJETIVOS F2": row.objetivos_fase2.completo ?
                                "COMPLETO" : "PENDIENTE",
                            "ESTADO PLANES F1": row.planes_fase1.completo ? "COMPLETO" :
                                "PENDIENTE",
                            "ESTADO PLANES F2": row.planes_fase2.completo ? "COMPLETO" :
                                "PENDIENTE"
                        }));
                    },
                    columnHeaders: true,
            ...
            document.getElementById('campania-filter').addEventListener('change', function(e) {
                ...
                table.setData("{{ route('seguimiento-evaluadores.data') }}", {
                    campania_id: campaniaId
                });

                tablaResumen.setData("{{ route('seguimiento-evaluadores.resumen-objetivos') }}", {
                    campania_id: campaniaId
                });
                ...
                if (campaniaId) {
                    fetch("{{ route('seguimiento-evaluadores.resumen') }}?campania_id=" + campaniaId)
                        ...
                        .then(data => {
                            ...
                            document.getElementById('barra-competencias').style.width = data
                            ...
                            document.getElementById('barra-objetivos-1').style.width = data.objetivos
                                .porcentaje_primera + '%';
                            document.getElementById('barra-objetivos-1').textContent = data.objetivos
                                .porcentaje_primera + '%';
                            document.getElementById('texto-objetivos-1').textContent =
                                `${data.objetivos.primera_fase} de ${data.objetivos.total} registrados`;

                            document.getElementById('barra-objetivos-2').style.width = data.objetivos
                                .porcentaje_segunda + '%';
                            document.getElementById('barra-objetivos-2').textContent = data.objetivos
                                .porcentaje_segunda + '%';
                            document.getElementById('texto-objetivos-2').textContent =
                                `${data.objetivos.segunda_fase} de ${data.objetivos.total} realizados`;

                            // Actualizar Planes
                            document.getElementById('barra-planes-1').style.width = data.planes
                                .porcentaje_primera + '%';
                            document.getElementById('barra-planes-1').textContent = data.planes
                                .porcentaje_primera + '%';
                            document.getElementById('texto-planes-1').textContent =
                                `${data.planes.primera_fase} de ${data.planes.total} registrados`;

                            document.getElementById('barra-planes-2').style.width = data.planes
                                .porcentaje_segunda + '%';
                            document.getElementById('barra-planes-2').textContent = data.planes
                                .porcentaje_segunda + '%';
