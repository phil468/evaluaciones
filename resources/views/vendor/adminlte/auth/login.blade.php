...
@section('auth_body')
    <div class="text-center">
        <a {{-- href = "#" --}} href="{{ url('/auth/redirect') }}" class="btn btn-primary btn-lg">
            <span><i class="fab fa-windows"></i></span>
            <span>Iniciar sesión</span>
        </a>
    </div>
    <button onclick="mostrarOcultarFormularioSesionLocal()" style="display: none;" accesskey="f">Mostrar Formulario de Sesion
        Local</button>
    ...
    <form action="{{ $login_url }}" method="post" {{-- style="display: none;" --}}>
        ...
        <div class="mb-3 input-group">
            <input type="email" name="email"
                class="form-control @error('email') is-invalid @enderror border border-primary" value="{{ old('email') }}"
        ...
        <div class="mb-3 input-group">
            <input type="password" id="password" name="password"
                class="form-control @error('password') is-invalid @enderror border border-primary"
