                    ...
                    <div class="text-white card-header bg-vanguard rounded-t-xl">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div class="float-left">
                                <h5 class="h5">Tipos de Puesto</h5>
                            </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-vanguard">
                    <h5 class="text-white modal-title h5" id="editModalLabel">Editar Tipo de Puesto</h5>
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function() {
            var table = new Tabulator("#example-table", {
                ajaxURL: "{{ route('tipo_de_puestos.data') }}",
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        formatter: function(cell, formatterParams) {
                            return "@can('editar-tipo-de-puesto')<button class='text-white btn btn-sm btn-warning edit-button' data-id='" +
                                cell.getRow().getData().id +
                                "'><i class='fas fa-edit'></i></button>@endcan" +
                                "@can('borrar-tipo-de-puesto')<button class='btn btn-sm btn-danger delete-button' data-id='" +
                                cell.getRow().getData().id +
            ...
            $('#saveChanges').on('click', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        var url = (id == '') ? "{{ route('tipo_de_puestos.store') }}" :
                            "{{ route('tipo_de_puestos.update', '') }}/" + id;
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: '¡Éxito!',
                                    text: 'Tipo de Puesto actualizado correctamente.',
                                });
                                table.replaceData();
                            },
                            error: function(xhr, status, error) {
                                Swal.fire({
                                    icon: 'error',
                                    title: '¡Error!',
                                    text: 'No se pudo actualizar el Tipo de Puesto.',
                                });
                            }
                        });
                    }
            ...
            $("#example-table").on("click", ".delete-button", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('tipo_de_puestos.destroy', '') }}/" + id,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            },
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
                                    title: '¡Éxito!',
                                    text: 'Tipo de Puesto eliminado correctamente.',
                                });
                                table.replaceData();
                            },
                            error: function(xhr, status, error) {
                                Swal.fire({
                                    icon: 'error',
                                    title: '¡Error!',
                                    text: 'No se pudo eliminar el Tipo de Puesto.',
                                });
                            }
                        });
                    }
