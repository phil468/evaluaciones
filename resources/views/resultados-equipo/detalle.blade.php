                    ...
                    <tr>
                            ...
                            <div class="progress" style="height: 25px;">
                                ...
                                @else
                                    <div class="progress-bar" role="progressbar" 
                                         style="width: {{ $datos['progreso'] }}%; background-color: #5bbfba;"></div>
                                @endif
                            </div>
                        </td>
                        <td style="width: 10%;" class="text-center">
                            ...
                            @else
                                ...
                                <small class="d-block text-muted">{{ $datos['puntajeObtenido'] }}/{{ $datos['puntajeEsperado'] }}</small>
                            @endif
                        </td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%;" class="text-right">
                            <button class="btn rounded-xl btn-vanguard btn-sm w-100" 
                                    {{ $datos['estado'] !== 'disponible' ? 'disabled' : '' }}
                                    onclick="verDetalle('pdi', {{ $anio }})" disabled>
                                Ver detalle
                            </button>
                        </td>
                    </tr>
