        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-vanguard">
                    <h5 class="text-white modal-title h5" id="editModalLabel">Editar Dominio</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="editForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="editGradoId">Grado</label>
                                    <select class="form-control" id="editGradoId">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        formatter: function(cell, formatterParams) {
                            return "@can('editar-dominio')<button class='text-white btn btn-sm btn-warning edit-button' data-id='" +
                                cell.getRow().getData().id +
                                "'><i class='fas fa-edit'></i></button>@endcan" +
                                "@can('borrar-dominio')<button class='btn btn-sm btn-danger delete-button' data-id='" +
                                cell.getRow().getData().id +
            ...
            $('#saveChanges').on('click', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        var url = (id == '') ? "{{ route('dominios.store') }}" :
                            "{{ route('dominios.update', '') }}/" + id;
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: '¡Éxito!',
                                    text: 'Dominio actualizado correctamente.',
                                });
                                table.replaceData();
                            },
                            error: function(xhr, status, error) {
                                Swal.fire({
                                    icon: 'error',
                                    title: '¡Error!',
                                    text: 'No se pudo actualizar el Dominio.',
                                });
                            }
                        });
                    }
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
                                    title: '¡Éxito!',
                                    text: 'Dominio eliminado correctamente.',
                                });
                                table.replaceData();
                            },
                            error: function(xhr, status, error) {
                                Swal.fire({
                                    icon: 'error',
                                    title: '¡Error!',
                                    text: 'No se pudo eliminar el Dominio.',
                                });
                            }
                        });
                    }
